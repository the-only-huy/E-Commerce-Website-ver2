            ...
            <div className="blog_details">
                <Link style={{ color: '#797979', fontSize: '18px' }} className="d-inline-block" to={`/blog-detail/${props.data.id}`}>
                    ...
                    <ul className="blog-info-link">
                        <li><i className="ti-user" /> {props.data.userData ? props.data.userData.firstName + " " + props.data.userData.lastName : "No User Data Available"}</li>
                        <li><i className="ti-commentss" /> {props.data.commentData.length} Bình luận</li>
                    </ul>
                </Link>
