                                    ...
                                    dataReceipt.map((item, index) => {
                                        return (
                                            <tr key={index}>
                                                ...
                                                <td>{item.supplierData ? item.supplierData.name : ''}</td>
                                                <td>{item.supplierData ? item.supplierData.phonenumber : ''}</td>
                                                <td>{item.userData ? item.userData.firstName + " " + item.userData.lastName : ''}</td>
